...
import JKFCampaignList from '@/components/ChristmasList/JKFCampaignList'
  ...
  return (
    ...
    >
      ...
      <CardRecommendProvider.Provider value={{ recommend: true, setVideoOpen }}>
        ...
        >
          {showList && <JKFCampaignList containerRef={containerRef} />}
        </div>
      </CardRecommendProvider.Provider>
    </div>
  )
}
export default JKFCampaign
