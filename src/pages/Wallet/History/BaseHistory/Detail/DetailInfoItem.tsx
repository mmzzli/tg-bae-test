...
const DetailInfoItem = ({
  ...
  return (
    <div className="flex min-h-[48px] w-full items-center justify-between gap-6 py-[14px]">
      <div className="flex h-full items-center whitespace-nowrap text-sm font-normal text-t3">
        {title}
      </div>
      <div className="flex max-w-[220px] grow justify-end gap-[6px] overflow-hidden text-t1">
        <div
